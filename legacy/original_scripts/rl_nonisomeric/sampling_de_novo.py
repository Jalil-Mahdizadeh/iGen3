...
try:
    #ckpt = "./iGen3.0_256_NOISO_RL_qed_sa_diverse/policy_best.pt"        # or policy_step0050.pt, etc.
    #sd = torch.load(ckpt, map_location="cpu")
    #torch.save(sd["state_dict"], "./model/iGen3.0_RL_qed-sa_best.pth")
